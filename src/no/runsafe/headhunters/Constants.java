...
public class Constants {
    ...
    public static final String TIME_TO_START_MSG = "The match will start in %s.";
    public static final String GAME_IN_PROGRESS_MSG = "The match has already been started.";
